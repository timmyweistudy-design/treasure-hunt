...
| `ROUTE_CELL` | `max(0.00008, bbox/360)`（≈9m） | 路線顯示 A* 格大小 |
| `CLCT_R` | `50` | 收集半徑（公尺） |
...
`app.py` 中硬編碼 40+ 城市座標，完全跳過 Nominatim 呼叫，防止 429 錯誤。
涵蓋：**全台灣 16 縣市**（台北/台中/台南/高雄/新竹/桃園/基隆/苗栗/彰化/南投/雲林/嘉義/屏東/宜蘭/花蓮/台東/澎湖）+ 東京/大阪/首爾/香港/新加坡/曼谷/巴黎/倫敦/紐約/洛杉磯/雪梨/墨爾本。
